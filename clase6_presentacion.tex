...
\title{Clase 6 — Introducción a Redes Neuronales}
...
\begin{frame}{Dataset sintético}
  \begin{itemize}
    \item Archivo: \texttt{data/estatura\_ninos.csv} (columnas: \texttt{age}, \texttt{height}).
...
\begin{frame}{Código de ejemplo}
  \begin{itemize}
    \item Ver \texttt{scripts/train\_estatura.py} para el código PyTorch completo.
    \item Ver \texttt{data/generate\_height\_data.py} para reproducir el CSV.
  \end{itemize}
\end{frame}
